...
export default function NextPage() {
  return (
    <>
      ...
      <div classNameName="grid grid-col-1 text-2xl w-full text-center">
        <div>
          <Image
            classNameName="ml-auto mr-auto"
            src=""
            alt="Logo image"
          />
        </div>
      ...
      <div classNameName="mt-1 w-full flex-wrap flex justify-center">
        <Link href="/home">
          <a classNameName="btn-blue">Go to home page</a>
        </Link>
      </div> */}

      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">

        <div className="max-w-lg mx-auto mt-8 bg-white dark:bg-black shadow-xl rounded-2xl sm:mt-12">
